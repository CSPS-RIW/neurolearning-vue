                ...
                <template v-slot:AccBody>
                  <ul class="en" v-show="locale === 'en'">
                   ...
                   <ul class=“fr” v-show="locale === 'fr'">
                    <li> <NewWindow Href="https://cmha.ca/fr" LinkText="L’Association canadienne pour la santé mentale" Title="Ouvre dans une nouvelle fenêtre/onglet" /> <a href=“” target=“_blank”></a> est
                    ...
                    <li> <NewWindow Href="https://jeunessejecoute.ca/" LinkText="Jeunesse, J’écoute" Title="Ouvre dans une nouvelle fenêtre/onglet" /> <a href=“” target=“_blank”></a> est un service national
                      ...
                      en français.</li>
                    <li> <NewWindow Href="https://hebergementfemmes.ca/" LinkText="Hebergementfemmes.ca" Title="Ouvre dans une nouvelle fenêtre/onglet" /> <a href=“” target=“_blank”></a> est une ressource en
                    ...
                    <li></li>
                    <li>La page Web sur la  <NewWindow Href="https://www.canada.ca/fr/sante-publique/sujets/violence-et-abus.html" LinkText="violence et les abus" Title="Ouvre dans une nouvelle fenêtre/onglet" /> <a href=“”
                    ...
                    <li> <NewWindow Href="https://www.wellnesstogether.ca/fr-CA" LinkText="Mieux-être ensemble Canada" Title="Ouvre dans une nouvelle fenêtre/onglet" /> <a href=“” target=“_blank”></a> offre
                ...
                <template #AccBody-2>
                  <ul class="en" v-show="locale === 'en'">
                    <li>The
                      ...
                      not-for-profit
                      corporation
                      governed and managed by Indigenous
                    ...
                    <li>The
                      ...
                      anonymous,
                      confidential
                      24/7 service staffed by trained
                    ...
                    <li>The
                      ...
                      24/7
                      toll-free
                      service available to anyone who requires
                    ...
                    <li>
                      <NewWindow Href="http://www.talk4healing.com/about/" LinkText="Talk4Healing" /><a href=""
                        target="_blank"></a> provides 24/7 phone, text, live chat counselling, and other
