          ...
          >
            <div class="instructional" v-if="!complete">
              ...
              <div class="role mb-5">
                  ...
                  <div class="tier1 clarify-role mt-5">
                      <Transition
                      name="custom-classes"
                      enter-active-class="animate__animated animate__fadeInDown"
                  ...
                  <div class="tier2 mt-5">
                    <div class="tier2-question1-wrapper">
                      <Transition
                      name="custom-classes"
                      enter-active-class="animate__animated animate__fadeInDown"
                      leave-active-class="animate__animated animate__fadeOutUp"
                    ...
                    <div class="tier2-question2-wrapper">
                      <Transition
                      name="custom-classes"
                      enter-active-class="animate__animated animate__fadeInDown"
                      leave-active-class="animate__animated animate__fadeOutUp"
                    ...
                    <div class="tier2-question3-wrapper">
                      <Transition
                      name="custom-classes"
                      enter-active-class="animate__animated animate__fadeInDown"
                      leave-active-class="animate__animated animate__fadeOutUp"
            ...
            <div class="instructional" v-else>
              <p>
