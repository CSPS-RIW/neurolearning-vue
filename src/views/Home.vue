                ...
                <Transition name="custom-classes" enter-active-class="animate__animated animate__fadeInDown">
                    <div class="instructional" v-if="!complete">
                        <div class="intro">
                            <div class="chat-container left blue">
                                ...
                                <p class="chat-bubble">Please select the relevant buttons in order to generate a
                                    customized resource toolkit. If you make a mistake, select the "Clear all inputs"
                                    button to clear the page.</p>
                            </div>
                        </div>
                        ...
                        <div class="role mb-5">
                            <div class="tier0 role-buttons d-flex justify-content-md-around mb-3">
                                <button class="btn btn-info btn-lg" role="button" aria-label="Employee"
                                    :disabled="role > 0 && true" @click="tier0Submit('employee')">Employee</button>
                                <button class="btn btn-info btn-lg" role="button" aria-label="Supervisor / Manager"
                                    :disabled="role > 0 && true" @click="tier0Submit('manager')">Supervisor /
                                    Manager</button>
                                <button class="btn btn-info btn-lg" role="button"
                                    aria-label="Mental Health Professional" :disabled="role > 0 && true"
                                    @click="tier0Submit('mental health')">Mental Health Professional</button>
                            </div>
                                ...
                                <Transition name="custom-classes"
                                    ...
                                    <div class="tier1-question1" key="1" v-if="role === 1">
                                        ...
                                        <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                            <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                :disabled="final1 > 0 && true"
                                                @click="tier1Submit('manager')">Yes</button>
                                            <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                :disabled="final1 > 0 && false"
                                                @click="tier1Submit('not manager')">No</button>
                                        </div>
                                    </div>
                                    <div class="tier1-question2" key="2" v-else-if="role === 2">
                                        ...
                                        <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                            <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                :disabled="final2 > 0 && true"
                                                @click="tier1Submit('executive')">Yes</button>
                                            <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                :disabled="final2 > 0 && false"
                                                @click="tier1Submit('not executive')">No</button>
                                        </div>
                                    </div>
                                    <div class="tier1-question3" key="3" v-else-if="role === 3">
                                        ...
                                        <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                            <button class="btn btn-info btn-lg" role="button"
                                                aria-label="Psychotherapist" :disabled="final3 > 0 && true"
                                                @click="tier1Submit('psychotherapist')">Psychotherapist</button>
                                            <button class="btn btn-info btn-lg" role="button" aria-label="Social Worker"
                                                :disabled="final3 > 0 && false"
                                                @click="tier1Submit('social worker')">Social Worker</button>
                                        </div>
                                    </div>
                                </Transition>
                            </div>
                                ...
                                <div class="tier2-question1-wrapper" aria-live="polite">
                                    <Transition name="custom-classes"
                                        ...
                                        <div class="tier2-question1-1" v-if="final1 === 1">
                                            ...
                                            <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                                <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                    @click="tier2Submit('manager claim')">Yes</button>
                                                <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                    @click="tier2Submit('not manager claim')">No</button>
                                            </div>
                                        </div>
                                        <div class="tier2-question1-2" v-else-if="final1 === 2">
                                            ...
                                            <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                                <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                    @click="tier2Submit('employee claim')">Yes</button>
                                                <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                    @click="tier2Submit('not employee claim')">No</button>
                                            </div>
                                        </div>
                                    </Transition>
                                </div>
                                <div class="tier2-question2-wrapper" aria-live="polite">
                                    <Transition name="custom-classes"
                                        ...
                                        <div class="tier2-question2-1" v-if="final2 === 1">
                                            ...
                                            <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                                <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                    @click="tier2Submit('action plan')">Yes</button>
                                                <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                    @click="tier2Submit('not action plan')">No</button>
                                            </div>
                                        </div>
                                        <div class="tier2-question2-2" v-else-if="final2 === 2">
                                            ...
                                            <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                                <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                    @click="tier2Submit('disability claim submission')">Yes</button>
                                                <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                    @click="tier2Submit('not disability claim submission')">No</button>
                                            </div>
                                        </div>
                                    </Transition>
                                </div>
                                <div class="tier2-question3-wrapper" aria-live="polite">
                                    <Transition name="custom-classes"
                                        ...
                                        <div class="tier2-question3-1" v-if="final3 === 1">
                                            ...
                                            <div class="d-flex justify-content-md-around mb-3 role-buttons">
                                                <button class="btn btn-info btn-lg" role="button" aria-label="Yes"
                                                    @click="tier2Submit('disability insurance')">Yes</button>
                                                <button class="btn btn-info btn-lg" role="button" aria-label="No"
                                                    @click="tier2Submit('not disability insurance')">No</button>
                                            </div>
                                        </div>
                                    </Transition>
                                </div>
                    ...
                    <div class="instructional" v-else aria-live="polite">
                        ...
                        <div v-if="manager">
                            ...
                            <p v-if="managerClaim">You have submitted a claim on your own behalf or on behalf of your
                                employee.</p>
                        </div>
                        <div v-if="executive">
                        ...
                        <div class="resources">
                            ...
                            <div class="card-container">
                                <div class="card" v-if="role === 1">
                                    <div class="card-body">
                                        <div>
                                            <a class="card-text" :href="resources.employeeItem">{{
                                                resources.employeeItem
                                            }}</a>
                                        </div>
                                        <!-- Tier 1 output -->
                                        <div v-if="final1 === 1">
                                            <a class="card-text" :href="resources.managerItem">{{
                            ...
                            <div class="card-container">
                                <div class="card" v-if="role === 2">
                                    <div class="card-body">
                                        ...
                                        <!-- Tier 1 output -->
                                        <div v-if="final2 === 1">
                                            <a class="card-text" :href="resources.executiveItem">{{
                                                resources.executiveItem
                                            }}</a>
                                        </div>
                                        <!-- Tier 2 output -->
                                        <div v-if="!actionPlan">
                                            <a class="card-text" :href="resources.actionPlanItem">{{
                                                resources.actionPlanItem
                                            }}</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-container">
                                <div class="card" v-if="MHRole === 'Psychotherapist'">
                                    <div class="card-body">
                                        <div>
                                            <a class="card-text" :href="resources.psychotherapistItem">{{
                                                resources.psychotherapistItem
                                            }}</a>
                                        </div>
                                        <div v-if="disabilityInsurance === false">
                                            <a class="card-text" :href="resources.disabilityItem">{{
                                                resources.disabilityItem
                                            }}</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-container">
                                <div class="card" v-if="MHRole === 'Social Worker'">
                                    <div class="card-body">
                                        <div>
                                            <a class="card-text" :href="resources.socialItem">{{
                                                resources.socialItem
                                            }}</a>
                                        </div>
                                        <div v-if="disabilityInsurance === false">
                                            <a class="card-text" :href="resources.disabilityItem">{{
...
export default {
    ...
    methods: {
        tier0Submit: function (description: string) {
        ...
        tier1Submit: function (clarifier: string) {
        ...
        tier2Submit: function (clarifier: string) {
            this.complete = true;
            switch (clarifier) {
                case 'manager claim':
